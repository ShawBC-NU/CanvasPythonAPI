...
class Filter:
    ...
    def add_condition(
        self, field: str, operator: Union[str, FilterOperator], value: Any
    ) -> "Filter":
        """
    ...
    def add_spatial_condition(self, operator: str, area: Rectangle) -> "Filter":
        ...
        """
        self.conditions.append(
            {"field": "spatial", "operator": f"spatial_{operator}", "value": area}
        )
        return self
    ...
    def add_wildcard_condition(self, field: str, pattern: str) -> "Filter":
        ...
        """
        self.conditions.append(
            {"field": field, "operator": "wildcard_match", "value": pattern}
        )
        return self
    ...
    def _matches_condition(
        self, item: Dict[str, Any], condition: Dict[str, Any]
    ) -> bool:
    ...
    def _matches_spatial_condition(
        self, item: Dict[str, Any], operator: str, area: Rectangle
    ) -> bool:
